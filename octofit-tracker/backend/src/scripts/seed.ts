...
async function seedDatabase() {
  try {
    ...
    console.log(
      `Seeded ${seedUsers.length} users, ${seedTeams.length} teams, ${seedActivities.length} activities, ${seedLeaderboard.length} leaderboard entries, and ${seedWorkouts.length} workouts.`,
    );
  } catch (error) {
